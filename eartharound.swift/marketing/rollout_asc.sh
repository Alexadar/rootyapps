...
for loc in en de ja fr es; do
  ...
  "$PY" "$LOGIC/upload_screenshots.py" --app-id $APP --platform IOS --display APP_IPAD_PRO_129 --version-id $VID_IOS \
      --locale "$L" --dir "aso/$loc/ipad/2048x2732" --replace 2>&1 | tail -2
