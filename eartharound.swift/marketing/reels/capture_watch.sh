...
# EA-, not SW-: another stale name inherited from a sibling app.
SIM_NAME="${SIM_NAME:-EA-Watch-S9-45}"
SIM_TYPE="${SIM_TYPE:-Apple Watch Series 9 (45mm)}"
...
UDID=$(ensure_sim "$SIM_NAME" "$SIM_TYPE" watchOS)
[ -n "$UDID" ] || { echo "❌ could not create watch simulator '$SIM_NAME'"; exit 1; }
