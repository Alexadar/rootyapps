...
public enum Par {
    ...
    public enum Palette {
        ...
        /// The keypad tray: recessed below `surface`, so the keys read as raised without a border.
        public static let surfaceRecessed = Color.white.opacity(0.04)
    ...
    public enum Metrics {
        ...
        /// Result rows and tape rows.
        public static let rowRadius: CGFloat = 16
        /// The provenance strip and other furniture that sits under content.
        public static let stripRadius: CGFloat = 14
        /// The gap between keypad keys.
        public static let keyGap: CGFloat = 7
